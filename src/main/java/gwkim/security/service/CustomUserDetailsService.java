...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    private final AuthorGroupMemberService authorGroupMemberService;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // < ================ 권한 세팅 ================
        List<AuthorGroupMemberDto> authorGroupMember = authorGroupMemberService.findAuthorGroupMember(member.getMemberId());
